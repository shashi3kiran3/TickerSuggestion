...
var onRequestGet4 = /* @__PURE__ */ __name(async ({ request }) => {
  try {
    const url = new URL(request.url);
...
// ../.wrangler/tmp/pages-xPof9j/functionsRoutes-0.3070576094929457.mjs
var routes = [
  {
    routePath: "/api/ai",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-xEyDgM/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-xEyDgM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8152856926932446.mjs.map
