...
// .wrangler/tmp/pages-Z5DQ4K/functionsWorker-0.008736202404062143.mjs
...
var onRequestGet3 = /* @__PURE__ */ __name2(async ({ request }) => {
  try {
    const url = new URL(request.url);
...
__name2(sanitizeRss, "sanitizeRss");
...
__name2(rankAndDedupe, "rankAndDedupe");
function dateMs(s) {
  if (!s) return 0;
...
__name2(filterStockMarket, "filterStockMarket");
function hash(s) {
  let h = 0;
...
var onRequestGet5 = /* @__PURE__ */ __name2(async ({ request }) => {
  try {
    const url = new URL(request.url);
...
var onRequestGet8 = /* @__PURE__ */ __name2(async ({ request }) => {
  try {
    const url = new URL(request.url);
    const symbol = url.searchParams.get("symbol") || "SPY";
    const range = url.searchParams.get("range") || "2y";
...
// .wrangler/tmp/bundle-jzTFfC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-jzTFfC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.008736202404062143.js.map
